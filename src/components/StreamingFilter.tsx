    ...
    <div className="relative">
      ...
      {isOpen && (
        <>
          ...
          />
          <div className="absolute top-full left-0 right-0 sm:right-auto mt-2 w-full sm:w-96 bg-gray-800 border border-gray-700 rounded-xl shadow-2xl z-[9999] max-h-[80vh] overflow-hidden">
            {/* Header */}
